...
import player.music.ancient.activities.base.AbsMusicServiceActivity
import player.music.ancient.databinding.ActivityLockScreenBinding
...
import player.music.ancient.fragments.player.lockscreen.LockScreenControlsFragment
...
class LockScreenActivity : AbsMusicServiceActivity() {
    ...
    private fun updateSongs() {
        ...
        Glide.with(this)
            ...
            .dontAnimate()
            .into(object : AncientMusicColoredTarget(binding.image) {
