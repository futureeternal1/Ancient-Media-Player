 ...
 *
 */
package player.music.ancient.activities.bugreport
...
import player.music.ancient.activities.bugreport.model.DeviceInfo
import player.music.ancient.databinding.ActivityBugReportBinding
...
open class BugReportActivity : AbsThemeActivity() {
    ...
    companion object {
        private const val ISSUE_TRACKER_LINK =
            "https://github.com/AncientMusicPlayer/AncientMusicPlayer/issues"
    }
}
