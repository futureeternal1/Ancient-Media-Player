...
import player.music.ancient.databinding.ActivitySongTagEditorBinding
...
import player.music.ancient.util.ImageUtil
import player.music.ancient.util.MusicUtil
import player.music.ancient.util.AncientColorUtil
...
class SongTagEditorActivity : AbsTagEditorActivity<ActivitySongTagEditorBinding>() {
    ...
    override fun loadCurrentImage() {
        ...
        setImageBitmap(
            bitmap,
            AncientColorUtil.getColor(
                AncientColorUtil.generatePalette(bitmap),
                defaultFooterColor()
            )
        )
        ...
        Glide.with(this@SongTagEditorActivity)
            ...
            .into(object : ImageViewTarget<BitmapPaletteWrapper>(binding.editorImage) {
                override fun onResourceReady(
                    ...
                    AncientColorUtil.getColor(resource.palette, Color.TRANSPARENT)
