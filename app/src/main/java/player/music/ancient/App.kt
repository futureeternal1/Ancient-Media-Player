...
import player.music.ancient.activities.ErrorActivity
...
import player.music.ancient.helper.WallpaperAccentManager
    ...
    override fun onCreate() {
        ...
        if (!ThemeStore.isConfigured(this, 3)) {
            ThemeStore.editTheme(this)
                .accentColorRes(player.music.ancient.R.color.md_deep_purple_A200)
