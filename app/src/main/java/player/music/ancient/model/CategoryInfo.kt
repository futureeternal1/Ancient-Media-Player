...
data class CategoryInfo(
    ...
    enum class Category(
        ...
        Radio(R.id.action_radio, R.string.radio, R.drawable.ic_radio),
        Tv(R.id.action_tv, R.string.tv, R.drawable.ic_tv),
        Videos(R.id.action_video, R.string.videos, R.drawable.ic_video),
        Youtube(R.id.action_youtube, R.string.youtube, R.drawable.ic_youtube);
    }
}
