...
import player.music.ancient.databinding.ItemGenreBinding
...
class GenreAdapter(
    ...
    private fun loadGenreImage(genre: Genre, holder: GenreAdapter.ViewHolder) {
        ...
        Glide.with(activity)
            ...
            .load(AncientGlideExtension.getSongModel(genreSong))
            .into(object : AncientMusicColoredTarget(holder.binding.image) {
