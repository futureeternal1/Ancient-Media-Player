...
import player.music.ancient.ThemeStore
...
class SearchAdapter(
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        if (dataSet[position] is RadioStationEntity) return RADIO
        ...
        when (getItemViewType(position)) {
            ...
            ARTIST -> {
                ...
                Glide.with(activity).asDrawable().artistImageOptions(artist).load(
                    AncientGlideExtension.getArtistModel(artist)
                ).into(holder.image!!)
            }
            ...
            SONG -> {
                ...
                Glide.with(activity).asDrawable().songCoverOptions(song)
                    .load(AncientGlideExtension.getSongModel(song)).into(holder.image!!)
            }
            ...
            RADIO -> {
                val radio = dataSet[position] as RadioStationEntity
                holder.title?.text = radio.name
                holder.text?.text = radio.uri
            }
