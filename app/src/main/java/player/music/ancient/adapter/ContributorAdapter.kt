...
import player.music.ancient.model.Contributor
import player.music.ancient.views.AncientShapeableImageView
...
class ContributorAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val image: AncientShapeableImageView = itemView.findViewById(R.id.icon)
