 ...
 *
 */
package player.music.ancient.adapter.artist
...
import player.music.ancient.interfaces.IAlbumArtistClickListener
...
class ArtistAdapter(
    ...
    private fun loadArtistImage(artist: Artist, holder: ViewHolder) {
        ...
        Glide.with(activity)
            ...
            .load(AncientGlideExtension.getArtistModel(artist))
