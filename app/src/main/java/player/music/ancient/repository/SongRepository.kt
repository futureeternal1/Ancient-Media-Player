...
import player.music.ancient.Constants.baseProjection
...
class RealSongRepository(private val context: Context) : SongRepository {
    ...
    private fun getSongFromCursorImpl(
        ...
        val isRadio = cursor.getColumnIndex("is_radio").let { columnIndex ->
            columnIndex != -1 && cursor.getInt(columnIndex) != 0
        }
        return Song(
            id,
            title,
