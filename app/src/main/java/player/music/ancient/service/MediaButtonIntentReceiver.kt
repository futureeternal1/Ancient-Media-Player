...
import player.music.ancient.service.MusicService.Companion.ACTION_PAUSE
import player.music.ancient.service.MusicService.Companion.ACTION_PLAY
...
import player.music.ancient.service.MusicService.Companion.ACTION_STOP
        ...
        private fun acquireWakeLockAndSendMessage(context: Context, msg: Message, delay: Long) {
            if (wakeLock == null) {
                ...
                wakeLock = pm?.newWakeLock(
                    ...
                    "AncientMusicApp:Wakelock headset button"
                )
