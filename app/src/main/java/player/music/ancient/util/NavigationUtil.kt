...
import player.music.ancient.activities.DriveModeActivity
import player.music.ancient.activities.LicenseActivity
import player.music.ancient.activities.SupportDevelopmentActivity
import player.music.ancient.activities.WhatsNewFragment
import player.music.ancient.activities.bugreport.BugReportActivity
import player.music.ancient.extensions.showToast
import player.music.ancient.helper.MusicPlayerRemote.audioSessionId
...
object NavigationUtil {
    ...
    fun openEqualizer(activity: Activity) {
        if (activity is FragmentActivity) {
            activity.findNavController(R.id.fragment_container).navigate(R.id.equalizer_fragment)
        } else {
