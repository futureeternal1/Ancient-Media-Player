...
import player.music.ancient.Constants.USER_BANNER
import player.music.ancient.Constants.USER_PROFILE
import player.music.ancient.R
import player.music.ancient.extensions.accentColor
import player.music.ancient.glide.artistimage.ArtistImage
import player.music.ancient.glide.audiocover.AudioFileCover
...
import player.music.ancient.util.ArtistSignatureUtil
import player.music.ancient.util.CustomArtistImageUtil.Companion.getFile
import player.music.ancient.util.CustomArtistImageUtil.Companion.getInstance
import player.music.ancient.util.MusicUtil.getMediaStoreAlbumCoverUri
...
object AncientGlideExtension {
    ...
    private val DEFAULT_RADIO_IMAGE: Int
        get() = R.drawable.ic_radio
