 ...
 *
 */
package player.music.ancient.fragments.albums
...
import player.music.ancient.common.ATHToolbarActivity.getToolbarBackgroundColor
import player.music.ancient.util.ToolbarContentTintHelper
import player.music.ancient.EXTRA_ALBUM_ID
import player.music.ancient.EXTRA_ARTIST_ID
import player.music.ancient.EXTRA_ARTIST_NAME
import player.music.ancient.R
import player.music.ancient.activities.tageditor.AbsTagEditorActivity
import player.music.ancient.activities.tageditor.AlbumTagEditorActivity
import player.music.ancient.adapter.album.HorizontalAlbumAdapter
import player.music.ancient.adapter.song.SimpleSongAdapter
import player.music.ancient.databinding.FragmentAlbumDetailsBinding
import player.music.ancient.dialogs.AddToPlaylistDialog
import player.music.ancient.dialogs.DeleteSongsDialog
...
import player.music.ancient.glide.AncientGlideExtension.artistImageOptions
import player.music.ancient.glide.AncientGlideExtension.asBitmapPalette
import player.music.ancient.glide.SingleColorTarget
import player.music.ancient.helper.MusicPlayerRemote
import player.music.ancient.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_A_Z
import player.music.ancient.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_DURATION
import player.music.ancient.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_TRACK_LIST
import player.music.ancient.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_Z_A
...
import player.music.ancient.util.*
...
class AlbumDetailsFragment : AbsMainActivityFragment(R.layout.fragment_album_details),
        ...
        if (lastFmAlbum.album != null) {
            ...
            if (lastFmAlbum.album.listeners.isNotEmpty()) {
                ...
                binding.fragmentAlbumContent.listeners.text =
                    AncientUtil.formatValue(lastFmAlbum.album.listeners.toFloat())
                binding.fragmentAlbumContent.scrobbles.text =
                    AncientUtil.formatValue(lastFmAlbum.album.playcount.toFloat())
            }
        }
    }
    ...
    private fun loadArtistImage(artist: Artist) {
        ...
        Glide.with(requireContext())
            ...
            .load(
                AncientGlideExtension.getArtistModel(
                    artist,
