package player.music.ancient.fragments.artists
...
import player.music.ancient.databinding.FragmentArtistDetailsBinding
...
import player.music.ancient.helper.SortOrder
...
abstract class AbsArtistDetailsFragment : AbsMainActivityFragment(R.layout.fragment_artist_details),
            ...
            if (bioContent != null && bioContent.trim { it <= ' ' }.isNotEmpty()) {
                binding.fragmentArtistContent.run {
                    ...
                    if (lastFmArtist.artist.stats.listeners.isNotEmpty()) {
                        ...
                        scrobblesLabel.show()
                        listeners.text =
                            AncientUtil.formatValue(lastFmArtist.artist.stats.listeners.toFloat())
                        scrobbles.text =
                            AncientUtil.formatValue(lastFmArtist.artist.stats.playcount.toFloat())
                    }
                }
            }
        }
    ...
    private fun loadArtistImage(artist: Artist) {
        Glide.with(requireContext()).asBitmapPalette().artistImageOptions(artist)
            .load(AncientGlideExtension.getArtistModel(artist)).dontAnimate()
