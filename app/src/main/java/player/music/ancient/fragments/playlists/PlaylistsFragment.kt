...
import player.music.ancient.EXTRA_PLAYLIST_ID
import player.music.ancient.R
import player.music.ancient.adapter.playlist.PlaylistAdapter
...
import player.music.ancient.fragments.base.AbsRecyclerViewCustomGridSizeFragment
...
class PlaylistsFragment :
    ...
    private fun setupGridSizeMenu(gridSizeMenu: SubMenu) {
        ...
        val gridSize = if (AncientUtil.isLandscape) 4 else 3
        if (gridSize < 8) {
