 ...
 *
 */
package player.music.ancient.fragments.genres
...
import player.music.ancient.EXTRA_GENRE
import player.music.ancient.R
import player.music.ancient.adapter.GenreAdapter
import player.music.ancient.extensions.setUpMediaRouteButton
import player.music.ancient.fragments.ReloadType
import player.music.ancient.fragments.base.AbsRecyclerViewFragment
import player.music.ancient.interfaces.IGenreClickListener
...
GenresFragment : AbsRecyclerViewFragment<GenreAdapter, LinearLayoutManager>(),
    ...
    override fun createLayoutManager(): LinearLayoutManager {
        return if (AncientUtil.isLandscape) {
