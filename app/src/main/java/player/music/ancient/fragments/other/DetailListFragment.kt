...
import player.music.ancient.adapter.song.ShuffleButtonSongAdapter
import player.music.ancient.adapter.song.SongAdapter
import player.music.ancient.databinding.FragmentPlaylistDetailBinding
import player.music.ancient.db.toSong
...
class DetailListFragment : AbsMainActivityFragment(R.layout.fragment_playlist_detail),
    ...
    private fun gridCount(): Int {
        if (AncientUtil.isTablet) {
            return if (AncientUtil.isLandscape) 6 else 4
        }
        return if (AncientUtil.isLandscape) 4 else 2
    }
