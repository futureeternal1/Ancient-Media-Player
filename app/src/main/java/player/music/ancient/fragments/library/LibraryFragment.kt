 ...
 *
 */
package player.music.ancient.fragments.library
...
import player.music.ancient.databinding.FragmentLibraryBinding
...
class LibraryFragment : AbsMainActivityFragment(R.layout.fragment_library) {
    ...
    private fun setupTitle() {
        ...
        val appName = "Ancient <span  style='color:$hexColor';>Music</span>".parseAsHtml()
