...
import player.music.ancient.cast.AncientWebServer.Companion.MIME_TYPE_AUDIO
import player.music.ancient.cast.AncientWebServer.Companion.PART_COVER_ART
import player.music.ancient.cast.AncientWebServer.Companion.PART_SONG
...
object CastHelper {
    ...
    fun Song.toMediaInfo(): MediaInfo? {
        ...
        val baseUrl: URL
        try {
            baseUrl = URL(CAST_URL_PROTOCOL, AncientUtil.getIpAddress(true), getCurrentServerPort(), "")
