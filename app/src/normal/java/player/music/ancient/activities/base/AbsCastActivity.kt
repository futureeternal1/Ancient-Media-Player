...
import player.music.ancient.cast.AncientSessionManagerListener
import player.music.ancient.cast.AncientWebServer
import player.music.ancient.helper.MusicPlayerRemote
import player.music.ancient.service.CastPlayer
...
abstract class AbsCastActivity : AbsSlidingMusicPanelActivity() {
    ...
    private val webServer: AncientWebServer by inject()
    ...
    private val sessionManagerListener by lazy {
        object : AncientSessionManagerListener {
